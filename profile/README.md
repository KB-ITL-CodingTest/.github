...
🔵 백트래킹도 난이도 낮은 문제가 없어서 처음 하시면 어려우실 수 있을 것 같아서 공통 문제 어렵다 싶으면 'N과 M' 문제가 단계별로 상당히 많아서 개인이 선택한 문제에 N과 M 문제 시리즈만 풀어오셔도 될 것 같습니다! (공통 문제의 실버 문제는 최대한 풀어오시면 좋을 것 같아요!)

  **<백트래킹>**
| 문제 번호 | 문제 이름 | 난이도 | 리뷰자 | 출처 | 
|-------|----------------|--------|------|-------|
| 1     |     [로또](https://www.acmicpc.net/problem/6603)        | 🟢 실버1  | 강서현 |  |
